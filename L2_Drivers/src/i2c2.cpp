...
///i2c_hw
bool I2C2::initSlave(const uint8_t slaveAddr,uint8_t * buffer, uint8_t size)
{
    //Initialize slave

    LPC_I2C2 -> I2ADR0  = slaveAddr;
    LPC_I2C2 -> I2MASK0 = 0x00;
    LPC_I2C2 -> I2MASK1 = 0x00;
    LPC_I2C2 -> I2MASK2 = 0x00;
    LPC_I2C2 -> I2MASK3 = 0x00;
    LPC_I2C2 -> I2CONSET= 0x44;
    buffer_base=buffer;
    buffer_base_size=size;
